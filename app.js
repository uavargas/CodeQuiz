...
const preguntas = {
    logica: [
        ...
        },
        {
            ...
            opciones: ["Una función", "Una estructura que repite código", "Un tipo de dato", "Un operador"],
            correcta: 1,
            dificultad: "facil",
        },
        {
            pregunta: "¿Qué es un algoritmo?",
            opciones: ["Un lenguaje de programación", "Un conjunto de pasos para resolver un problema", "Una base de datos", "Un tipo de variable"],
            correcta: 1,
            dificultad: "facil",
        },
        {
            pregunta: "¿Qué es un arreglo (array)?",
            opciones: ["Una colección de elementos del mismo tipo", "Un tipo de función", "Un operador lógico", "Una condición"],
            correcta: 0,
            dificultad: "facil",
        },
        {
        ...
        },
        {
            ...
            opciones: ["Un tipo de dato", "Un bloque de código reutilizable", "Un error en el código", "Una variable global"],
            correcta: 1,
            dificultad: "facil",
        },
        {
            pregunta: "¿Qué tipo de bucle se ejecuta mientras una condición sea verdadera?",
            opciones: ["Bucle for", "Bucle while", "Bucle do-while", "Bucle infinito"],
            correcta: 1,
            dificultad: "facil",
        },
        {
        ...
        },
        {
            ...
            opciones: ["Un error en el código", "Texto ignorado por el compilador", "Una función", "Una variable"],
            correcta: 1,
            dificultad: "facil",
        },
        {
            pregunta: "¿Qué hace el operador '%' en programación?",
            opciones: ["Multiplicación", "División", "Módulo (residuo de la división)", "Suma"],
            correcta: 2,
            dificultad: "medio",
        },
        {
            pregunta: "¿Qué es la recursividad?",
            opciones: ["Un tipo de bucle", "Una función que se llama a sí misma", "Un error de sintaxis", "Una estructura de datos"],
            correcta: 1,
            dificultad: "medio",
        },
        {
            pregunta: "¿Qué es un parámetro en una función?",
            opciones: ["Un valor que la función recibe", "Un valor que la función retorna", "Un tipo de bucle", "Un operador"],
            correcta: 0,
            dificultad: "medio",
        },
        {
            pregunta: "¿Qué es un bucle 'do-while'?",
            opciones: ["Un bucle que se ejecuta al menos una vez", "Un bucle que no se ejecuta nunca", "Un bucle infinito", "Un bucle que solo funciona con números"],
            correcta: 0,
            dificultad: "medio",
        },
        {
            pregunta: "¿Qué es un operador ternario?",
            opciones: ["Un operador que toma tres operandos", "Un operador lógico", "Un tipo de bucle", "Una función"],
            correcta: 0,
            dificultad: "medio",
        }
    ],
    java: [
        {
            ...
            opciones: ["Un sistema operativo", "Un lenguaje de programación orientado a objetos", "Un navegador web", "Una base de datos"],
            correcta: 1,
            dificultad: "facil"
        },
        {
...
function cargarTema(tema) {
    const temasEnDesarrollo = ["git", "aws", "javascript", "desarrollo-web", "python", "basesDeDatos"];
...
function mostrarResultados() {
    ...
    document.getElementById("resultadoTitulo").textContent = `¡Felicidades ${nombreParticipante}!`;
    document.getElementById("resultadoPuntaje").textContent = `Obtuviste ${puntaje} de ${total} respuestas correctas (${porcentaje.toFixed(1)}%)`;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelector(".close-modal").addEventListener("click", ocultarModal);
    
    // Cerrar modal al hacer clic fuera del contenido
    document.getElementById("participanteModal").addEventListener("click", function(e) {
        if (e.target === this) {
            ocultarModal();
        }
    });
